	...
	<script src="https://maps.googleapis.com/maps/api/js?v=3.exp&sensor=false"></script>
	 <script>
		...
		function initialize() {
		  ...
		  var featureOpts = [ { "stylers": [ { "invert_lightness": true }, { "hue": "#0077ff" } ] } ];
...
<body>
    ...
    <div id="homepage">
        <div class="homepage-content">
            ...
            <div class="twelve columns">
                <p class="homepage-text">Bliži se jubilarna druga godišnjica ZgPHP meetupa. Za proslavu smo odlučili umjesto uobičajenog meetupa organizirati jednodnevnu PHP konferenciju koja će se održati 14. rujna 2013.</p>
            </div>
		...
		<div id="predavaci">
			<div class="box">
				<div class="content-content">
					...
					<div class="twelve columns">
						<p class="content-text">Već imamo najavljeno nekoliko zanimljivih predavača iz Hrvatske i regije, ali kapaciteti nam nisu do kraja popunjeni. Ukoliko ste zainteresirani za predavanje na konferenciji, javite nam se najkasnije do 18. kolovoza 2013. s vašim kontakt podacima, kratkom biografijom i sažetkom predavanja. Predavačima koji dolaze izvan Zagreba nudimo pomoć u financiranju puta i smještaja.</p>
					</div>
					<div class="twelve columns">
		...
		<div id="posjetitelji">
			<div class="box">
				<div class="content-content">
					...
					<div class="twelve columns">
						<p class="content-text">To je najbolja stvar! Konferencija je besplatna za sve posjetitelje. Ipak, napomenuli bi da je broj mjesta je ograničen što znači dvije stvari:</p>
					</div>
					<div class="twelve columns">
						<p class="content-text" style="margin: 5% 0 1%;"><a href="http://www.meetup.com/ZgPHP-meetup/events/132112512/" class="submit-button">prijavite se sto prije</a></p>
					</div>
					<div class="twelve columns">
							<ul class="content-text">
								<li>ukoliko se pokaže da ne možete doći, otkažite svoju prijavu na vrijeme i omogućite drugima da prisustvuju</li>
							</ul>
						<p class="content-text">Također, zamolili bi i za dvije minute vašeg vremena. Pošaljite ovaj link svojim prijateljima, shareajte ga na Twitteru i Facebooku, javite ga predavačima koje bi željeli poslušati i skrenite pažnju šefovima koji bi voljeli sponzorirati.</p>
					</div>
				</div>
			</div>
		</div>
		...
		<div id="sponzori">
			<div class="box">
				<div class="content-content">
					...
					<div class="twelve columns">
						<p class="content-text">Pripremili smo sponzorski paket, za firme koje žele financijski pomoći u organizaciji konferencije. <a href="http://zgphp.org/2013/07/zgphp-meetup-konferencija-2013/">Sponzorstvom</a> pomažete u pokrivanju troškova dolaska predavača i kupovine hrane i pića za posjetitelje. Zauzvrat nudimo mogućnost promoviranja firme ispred stotinjak developera. Pogledajte detalje sponzorskog paketa i iskoristite priliku uhvatiti najbolje programere Zagreba i okolice.</p>
					</div>
